...
type: general
image: /Blog/assets/img/ia/diagramadeafinidad.png
...
1. **Recolecta** ideas (una por nota/post-it).  
2. **Lee sin juzgar.** Evita clasificar de inmediato.  
3. **Agrupa por afinidad.** Junta notas que hablen del mismo fenómeno.  
4. **Nombra los grupos.** Etiquetas cortas y precisas.  
5. **Analiza el patrón.** ¿Qué grupos concentran más ideas? ¿Qué falta?  
